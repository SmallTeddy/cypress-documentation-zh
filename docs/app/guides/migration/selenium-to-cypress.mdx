...
is its [unique approach](/app/get-started/why-cypress#架构) of running tests
inside an interactive browser rather than against one. This approach [minimizes flakiness](/app/get-started/why-cypress#抗波动)
